...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "http://localhost:8888/todo-api";
 ...
 * @version v0
 * @baseUrl http://localhost:8888/todo-api
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
    ...
    getTodos: (params: RequestParams = {}) =>
      this.request<TodoResponseDto[], any>({
        path: `/api/todo`,
        method: "GET",
        ...params,
      }),
     ...
     */
    createTodo: (data: TodoRequestDto, params: RequestParams = {}) =>
      this.request<TodoResponseDto, any>({
        path: `/api/todo`,
        method: "POST",
        body: data,
     ...
     */
    updateTodo: (id: string, data: TodoRequestDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/todo/${id}`,
        method: "PATCH",
        body: data,
